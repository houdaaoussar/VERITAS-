/*
  ...
  - Added the required column `original_filename` to the `uploads` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_uploads" ("customer_id", "error_count", "filename", "id", "period_id", "s3_key", "site_id", "status", "uploaded_at", "uploaded_by") SELECT "customer_id", "error_count", "filename", "id", "period_id", "s3_key", "site_id", "status", "uploaded_at", "uploaded_by" FROM "uploads";
DROP TABLE "uploads";
